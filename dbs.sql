CREATE DATABASE  IF NOT EXISTS `dz_events` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `dz_events`;
...
CREATE TABLE `event_participation` (
  ...
  `rajout` text,
  `participation_status` enum('en_cours','accepte') DEFAULT 'en_cours',
...
INSERT INTO `event_participation` VALUES (3,16,7,'x','xcz','professionnelle','x','en_cours','2024-12-15 04:22:55'),(4,10,12,'x','x','professionnelle','x','en_cours','2024-12-16 04:11:09'),(5,17,12,'n ','l n','etudiant',';kn','en_cours','2024-12-17 03:42:48'),(6,17,7,'xx','x','retraité','x','en_cours','2024-12-17 04:02:05'),(7,19,6,'sss','xs','professionnelle','s','en_cours','2024-12-17 23:22:22'),(8,19,7,'z','z','etudiant','x','en_cours','2024-12-18 01:30:49'),(9,17,7,'x','s','retraité','sacd','en_cours','2024-12-18 06:35:17'),(10,17,7,'x','s','retraité','sacd','en_cours','2024-12-18 06:36:47'),(11,17,7,'test','ss','retraité','x','en_cours','2024-12-18 07:02:18'),(12,17,7,'sirine','sirine','etudiant','x','en_cours','2024-12-18 07:03:09');
...
INSERT INTO `event_requests` VALUES (12,'a',12,'Annaba','2012-12-12','12:12:00',17,'pending','s','https://fr.freepik.com/photos/nature','2024-12-15 09:14:12','Musique'),(14,'abcd',122,'Oran','2024-12-12','23:23:00',17,'pending','23','https://fr.freepik.com/photos/nature','2024-12-15 03:14:42','religieux'),(18,'ren',3,'Setif','2030-12-12','08:20:00',19,'pending','hwcd','path/pic.jpg','2024-12-17 23:29:41','religieux'),(19,'xx ',123,'Constantine','2004-12-12','12:12:00',19,'pending','sdac','rg.png','2024-12-18 01:36:19','Séminaire');
...
-- Dump completed on 2024-12-18 10:56:38
